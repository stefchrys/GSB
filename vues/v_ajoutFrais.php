...
<form method='POST' action='index.php?uc=gererFrais&action=validerCreationFrais'>
    <table class='tabNonQuadrille'>
        <tr>
            ...
            <td>
                <input  type='text' name='txt_dateFrais'  size='30' maxlength='45'>
            </td>
        </tr>
        <tr>
            <td>Description du frais</td>
            <td>
                <input  type='text' name='txt_description' size='50' maxlength='100'>
            </td>
        </tr>
        <tr>
            <td>Montant engage</td>
            <td>
                <input  type='text' name='txt_montant'  size='30' maxlength='45'>
            </td>
        </tr>
        <tr>
            <td>Justificatif</td>
